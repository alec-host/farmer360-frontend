...
const EntityList = () => {
  ...
  const renderFarmerList = (farmer) => {
    return(
      <div key={farmer.$id} className={"card mb-3 col-md-12" + " "+styles.justifyleft} style={{maxWidth:'40rem',paddingBlock:'15px',margin:'10px'}}>
    ...
    <>
      <div className="container">
        <div className="row justify-content-center" style={{background:""}}>
          ...
          <div className="row">
            {loading ? <FormLoading /> : <DisplayInfiniteScroll />}
          </div>
        </div>
      </div>
    </>
