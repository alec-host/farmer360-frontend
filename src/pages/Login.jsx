...
import { INBOX_KEY, PRODUCT_KEY, PROFILE_KEY, STORE_KEY, storeOnLocalCache } from "../db/localSessionData";
import API_END_POINT from "../endpoint/apiRoute";

const getShop = (reference_number,email) => {
...
const getProduct = (reference_number,email) => {
  console.log(reference_number);
  console.log(email);
  const config = {
  method: 'GET',
...
const getInbox = (reference_number,email) => {
  console.log(reference_number);
  console.log(email);
  const config = {
  method: 'GET',
