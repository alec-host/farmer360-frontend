...
const Register = () => {
    ...
    const inputEntityType = useRef(null);
    ...
    const [selectedEntity,setEntitySelected] = useState(entity_options[0].value);
    ...
    const handleSubmit = (event) => {
        ...
        if(inputPassword?.current?.value !== inputConfirmPassword?.current?.value){
            ...
            formData.entity_type = selectedEntity;
    ...
    const httpPost = (formData) => {
        fetch(`${API_END_POINT}/api/v1/createNewUser`,{
            method:'POST',
