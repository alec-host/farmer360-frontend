...
const ConnectAndShareStoryPage = () => {
    ...
    return (
      <>
        <div className="container-fluid" style={{paddingTop:"10px",height:"auto"}}>
                            ...
                            <tr>
                                <td width="50px">
                                    <Avatar 
                                        ...
                                        size={50}
                                        className="me-1"
                                        name={storeProfileData[0]?.first_name !== "" || typeof(storeProfileData[0]?.first_name) !== "undefined" ? storeProfileData[0]?.first_name : ""}
                                        round={true}  
                                    />                                    
                                </td>
                                <td>
